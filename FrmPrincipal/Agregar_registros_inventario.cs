...
namespace Simael
{
    public partial class Agregar_registros_inventario : UserControl
    {
        private Agregar_periferico objPeriferico;
        private Agregar_pc objComp;
        public Agregar_registros_inventario()
        {
            InitializeComponent();
        }
        ...
        private void checkPeriferico_CheckedChanged(object sender, EventArgs e)
        {
            if (checkPeriferico.Checked)
            {
                ...
                objPeriferico = new Agregar_periferico();
                removerFormularios();
