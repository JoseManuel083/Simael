    ...
    public partial class FrmAgregarReportes : UserControl
    {
        ...
        private void establecerDatosReporte(List<String> equipo) 
        {
            if (equipo.Count == 20)
            {
                ...
                txtProcesador.Text = equipo.ElementAt(9);
                txtHdd.Text = equipo.ElementAt(12);
                txtCosto.Text = equipo.ElementAt(16);
                txtResguardante.Text = equipo.ElementAt(17);
                txtArea.Text = equipo.ElementAt(18); ;
                txtFalla.Text = equipo.ElementAt(19);
            }
            else if (equipo.Count == 14)
            {
                txtSoi.Text = equipo.ElementAt(0); ;
                txtSicipo.Text = equipo.ElementAt(1);
                txtTipo.Text = equipo.ElementAt(2);
        ...
        private void agregarDatosReporte() 
        {
            ...
            dvfechaAd.Value = pickerFecha.Value.ToString();
