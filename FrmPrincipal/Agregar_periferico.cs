...
namespace Simael
{
    public partial class Agregar_periferico : UserControl
    {
        private BaseDatoBit objBD;
        public Agregar_periferico()
        {
            InitializeComponent();
        }
        ...
        private void agregarPeriferico() 
        {
            ...
            bool estado;
            estado = objBD.agregarPerifericoInventario(sicipo,folio, categoria, tipo, marca, modelo, noserie, color,
